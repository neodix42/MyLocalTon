  ...
  private void extractBinaries() throws IOException {
    synchronized (Extractor.class) {
      if (Files.notExists(
        ...
        extractFile(
            "org/ton/binaries/patches/gen-zerostate.fif",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
        ...
        extractFile(
            "org/ton/binaries/patches/faucet.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
                ...
                + "faucet.pk");
        extractFile(
            "org/ton/binaries/patches/faucet-highload.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
                ...
                + "faucet-highload.pk");
        extractFile(
            "org/ton/binaries/patches/data-highload.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
                ...
                + "data-highload.pk");
        extractFile(
            "org/ton/binaries/patches/validator.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
                ...
                + "validator.pk");
        extractFile(
            "org/ton/binaries/patches/validator-1.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
                ...
                + "validator-1.pk");
        extractFile(
            "org/ton/binaries/patches/validator-2.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
                ...
                + "validator-2.pk");
        extractFile(
            "org/ton/binaries/patches/validator-3.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
                ...
                + "validator-3.pk");
        extractFile(
            "org/ton/binaries/patches/validator-4.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
                ...
                + "validator-4.pk");
        extractFile(
            "org/ton/binaries/patches/validator-5.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
        ...
        extractFile(
            "org/ton/binaries/patches/validator-6.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
        ...
        extractFile(
            "org/ton/binaries/patches/validator-7.pk",
            MY_LOCAL_TON_ROOT_DIR
                + nodeName
                + File.separator
                + BIN
    ...
    try {
      if (!Files.exists(
        ...
        InputStream sendSignalCtrlC64 =
            Extractor.class
                .getClassLoader()
                .getResourceAsStream("org/ton/binaries/utils/SendSignalCtrlC64.exe");
        Files.copy(
            sendSignalCtrlC64,
        ...
        InputStream du =
            Extractor.class.getClassLoader().getResourceAsStream("org/ton/binaries/utils/du.exe");
        Files.copy(
            du,
            Paths.get(MY_LOCAL_TON_ROOT_DIR + UTILS + File.separator + "du.exe"),
            StandardCopyOption.REPLACE_EXISTING);
        ...
        InputStream cygWinDll =
            Extractor.class
                .getClassLoader()
                .getResourceAsStream("org/ton/binaries/utils/cygwin1.dll");
        Files.copy(
            cygWinDll,
        ...
        InputStream cygIntlDll =
            Extractor.class
                .getClassLoader()
                .getResourceAsStream("org/ton/binaries/utils/cygintl-8.dll");
        Files.copy(
            cygIntlDll,
        ...
        InputStream cygIconDll =
            Extractor.class
                .getClassLoader()
                .getResourceAsStream("org/ton/binaries/utils/cygiconv-2.dll");
        Files.copy(
            cygIconDll,
    ...
    try {
      if (nonNull(MyLocalTon.getInstance().getSettings().getCustomTonBinariesPath())) {
        ...
        InputStream binaries =
            Extractor.class.getClassLoader().getResourceAsStream("org/ton/binaries/" + WINDOWS_ZIP);
        if (isNull(binaries)) {
    ...
    try {
      if (nonNull(MyLocalTon.getInstance().getSettings().getCustomTonBinariesPath())) {
        ...
        InputStream binaries =
            Extractor.class
                .getClassLoader()
                .getResourceAsStream("org/ton/binaries/" + platform + ".zip");
        Files.copy(
            binaries,
            Paths.get(
                MY_LOCAL_TON_ROOT_DIR
  ...
  private void extractMacBinaries(String platform) {
    try {
      if (nonNull(MyLocalTon.getInstance().getSettings().getCustomTonBinariesPath())) {
        ...
        InputStream binaries =
            Extractor.class.getClassLoader().getResourceAsStream("org/ton/binaries/" + platform);
        Files.copy(
            binaries,
            Paths.get(
                MY_LOCAL_TON_ROOT_DIR
