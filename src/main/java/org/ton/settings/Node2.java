...
import static org.ton.actions.MyLocalTon.ZEROSTATE;
...
public class Node2 implements Serializable, Node {
  ...
  Long validatorBlockTtl =
      365
          * 86400L; // 1 year, blocks will be gc'd after this time (in seconds) default=7*86400, 7
                    // days
  Long validatorArchiveTtl =
      365
          * 86400L; // 1 year, archived blocks will be deleted after this time (in seconds)
                    // default=365*86400, 1 year
  Long validatorKeyProofTtl =
      10 * 365
          * 86400L; // 10 years, key blocks will be deleted after this time (in seconds)
  ...
  String nodeLocalConfigLocation =
      getTonDbDir()
  ...
  public String getValidatorBaseFile() {
    return this.getTonBinDir() + ZEROSTATE + File.separator + "validator-1";
  }
}
