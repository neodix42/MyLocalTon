...
public class MainController implements Initializable {
  ...
  @FXML public CustomInfoLabel currentBlockNum;

  @FXML public CustomInfoLabel liteClientInfo;
  ...
  @FXML public JFXListView<Node> accountsvboxid;

  @FXML public TextField nodeStateTtl1;

  @FXML public TextField nodeBlockTtl1;

  @FXML public TextField nodeArchiveTtl1;

  @FXML public TextField nodeKeyProofTtl1;

  @FXML public TextField nodeSyncBefore1;

  @FXML public JFXButton myLocalTonDbDirBtn;

  @FXML public Tab logsTab;

  @FXML public Tab validationTab;

  @FXML public JFXTabPane validationTabs;

  @FXML public Label nodeStatus2;

  @FXML public Label nodeStatus3;

  @FXML public Label nodePublicPort1;

  @FXML public Label nodeConsolePort1;

  @FXML public Label liteServerPort1;
  ...
  @FXML public Label validator1WalletAddress;

  @FXML public Label validator1AdnlAddress;

  @FXML public Label blockchainLaunched;

  @FXML public Label startCycle;

  @FXML public Label endCycle;

  @FXML public Label startElections;

  @FXML public Label endElections;

  @FXML public Label nextElections;

  @FXML public Label minterAddr;

  @FXML public Label configAddr;

  @FXML public Label electorAddr;

  @FXML public Label validationPeriod;

  @FXML public Label electionPeriod;

  @FXML public Label holdPeriod;

  @FXML public Label minimumStake;

  @FXML public Label maximumStake;

  @FXML public Label validator1PubKeyHex;

  @FXML public ProgressBar validationCountDown;

  @FXML public Label minterBalance;

  @FXML public Label configBalance;

  @FXML public Label electorBalance;

  @FXML public Label legendHoldStake;

  @FXML public Label legendValidation;

  @FXML public Label legendElections;

  @FXML public Label legendPause;

  @FXML public Label stakeHoldRange3;

  @FXML public Label validationRange3;

  @FXML public Label pauseRange3;

  @FXML public Label electionsRange3;

  @FXML public Label stakeHoldRange2;

  @FXML public Label validationRange2;

  @FXML public Label pauseRange2;

  @FXML public Label electionsRange2;

  @FXML public Label stakeHoldRange1;

  @FXML public Label validationRange1;

  @FXML public Label pauseRange1;

  @FXML public Label electionsRange1;

  @FXML public Pane electionsChartPane;

  @FXML public Separator timeLine;

  @FXML public Label validator1PubKeyInteger;

  @FXML public ProgressBar progressValidationUpdate;

  @FXML public Label validator1AdnlAddressNext;

  @FXML public Label validator1PubKeyHexNext;

  @FXML public Label validator1PubKeyIntegerNext;

  @FXML public Label validator1totalCollected;

  @FXML public Label validator1LastCollected;

  @FXML public Label validator1TotalRewardsPure;

  @FXML public Label validator1LastRewardPure;

  @FXML public Label validator1AvgPureReward;

  @FXML public Label participatedInElections1;

  @FXML public JFXButton addValidatorBtn;

  @FXML public Tab genesisnode1;

  @FXML public Tab validator2tab;

  @FXML public Tab validator3tab;

  @FXML public Tab validator4tab;

  @FXML public Tab validator5tab;

  @FXML public Tab validator6tab;

  @FXML public Tab validator7tab;

  @FXML public Label nodePublicPort2;

  @FXML public Label nodeConsolePort2;

  @FXML public Label liteServerPort2;

  @FXML public Label validator2AdnlAddress;

  @FXML public Label validator2PubKeyHex;

  @FXML public Label validator2PubKeyInteger;

  @FXML public Label validator2AdnlAddressNext;

  @FXML public Label validator2PubKeyIntegerNext;

  @FXML public Label validator2PubKeyHexNext;

  @FXML public Label validator2WalletAddress;

  @FXML public Label validator2WalletBalance;

  @FXML public Label validator2totalCollected;

  @FXML public Label validator2LastCollected;

  @FXML public Label validator2TotalRewardsPure;

  @FXML public Label validator2LastRewardPure;

  @FXML public Label validator2AvgPureReward;

  @FXML public Label participatedInElections2;

  @FXML public JFXButton deleteValidatorBtn2;

  @FXML public Label nodePublicPort3;

  @FXML public Label nodeConsolePort3;

  @FXML public Label liteServerPort3;

  @FXML public Label validator3AdnlAddress;

  @FXML public Label validator3PubKeyHex;

  @FXML public Label validator3PubKeyInteger;

  @FXML public Label validator3AdnlAddressNext;

  @FXML public Label validator3PubKeyHexNext;

  @FXML public Label validator3PubKeyIntegerNext;

  @FXML public Label validator3WalletAddress;

  @FXML public Label validator3WalletBalance;

  @FXML public Label validator3totalCollected;

  @FXML public Label validator3TotalRewardsPure;

  @FXML public Label validator3LastCollected;

  @FXML public Label validator3LastRewardPure;

  @FXML public Label validator3AvgPureReward;

  @FXML public Label participatedInElections3;

  @FXML public JFXButton deleteValidatorBtn3;

  @FXML public Label nodeStatus4;

  @FXML public Label nodePublicPort4;

  @FXML public Label nodeConsolePort4;

  @FXML public Label liteServerPort4;

  @FXML public Label validator4AdnlAddress;

  @FXML public Label validator4AdnlAddressNext;

  @FXML public Label validator4PubKeyHexNext;

  @FXML public Label validator4PubKeyIntegerNext;

  @FXML public Label validator4WalletAddress;

  @FXML public Label validator4WalletBalance;

  @FXML public Label validator4totalCollected;

  @FXML public Label validator4LastCollected;

  @FXML public Label validator4TotalRewardsPure;

  @FXML public Label validator4LastRewardPure;

  @FXML public Label validator4AvgPureReward;

  @FXML public Label participatedInElections4;

  @FXML public JFXButton deleteValidatorBtn4;

  @FXML public Label nodeStatus5;

  @FXML public Label nodePublicPort5;

  @FXML public Label nodeConsolePort5;

  @FXML public Label liteServerPort5;

  @FXML public Label validator5AdnlAddress;

  @FXML public Label validator5PubKeyHex;

  @FXML public Label validator5PubKeyInteger;

  @FXML public Label validator5AdnlAddressNext;

  @FXML public Label validator5PubKeyHexNext;

  @FXML public Label validator5PubKeyIntegerNext;

  @FXML public Label validator5WalletAddress;

  @FXML public Label validator5WalletBalance;

  @FXML public Label validator5totalCollected;

  @FXML public Label validator5LastCollected;

  @FXML public Label validator5TotalRewardsPure;

  @FXML public Label validator5LastRewardPure;

  @FXML public Label validator5AvgPureReward;

  @FXML public Label participatedInElections5;

  @FXML public JFXButton deleteValidatorBtn5;

  @FXML public Label nodeStatus6;

  @FXML public Label nodePublicPort6;

  @FXML public Label nodeConsolePort6;

  @FXML public Label liteServerPort6;

  @FXML public Label validator6AdnlAddress;

  @FXML public Label validator6PubKeyHex;

  @FXML public Label validator6PubKeyInteger;

  @FXML public Label validator6AdnlAddressNext;

  @FXML public Label validator6PubKeyHexNext;

  @FXML public Label validator6PubKeyIntegerNext;

  @FXML public Label validator6WalletAddress;

  @FXML public Label validator6WalletBalance;

  @FXML public Label validator6totalCollected;

  @FXML public Label validator6LastCollected;

  @FXML public Label validator6TotalRewardsPure;

  @FXML public Label validator6LastRewardPure;

  @FXML public Label validator6AvgPureReward;

  @FXML public Label participatedInElections6;

  @FXML public JFXButton deleteValidatorBtn6;

  @FXML public Label nodeStatus7;

  @FXML public Label nodePublicPort7;

  @FXML public Label nodeConsolePort7;

  @FXML public Label liteServerPort7;

  @FXML public Label validator7AdnlAddress;

  @FXML public Label validator7PubKeyHex;

  @FXML public Label validator7PubKeyInteger;

  @FXML public Label validator7AdnlAddressNext;

  @FXML public Label validator7PubKeyHexNext;

  @FXML public Label validator7PubKeyIntegerNext;

  @FXML public Label validator7WalletAddress;

  @FXML public Label validator7WalletBalance;

  @FXML public Label validator7totalCollected;

  @FXML public Label validator7LastCollected;

  @FXML public Label validator7TotalRewardsPure;

  @FXML public Label validator7LastRewardPure;

  @FXML public Label validator7AvgPureReward;

  @FXML public Label participatedInElections7;

  @FXML public JFXButton deleteValidatorBtn7;

  @FXML public Label validator4PubKeyHex;

  @FXML public Label validator4PubKeyInteger;

  @FXML public Tab settingsLogsValidator1Tab;

  @FXML public JFXTabPane subLogsTabs;

  @FXML public JFXTextField nodeStateTtl2;

  @FXML public JFXTextField nodeBlockTtl2;

  @FXML public JFXTextField nodeArchiveTtl2;

  @FXML public JFXTextField nodeKeyProofTtl2;

  @FXML public JFXTextField nodeSyncBefore2;

  @FXML public JFXTextField configNodePublicPort2;

  @FXML public JFXTextField configNodeConsolePort2;

  @FXML public JFXTextField configLiteServerPort2;

  @FXML public JFXTextField validatorWalletDeposit2;

  @FXML public JFXTextField validatorDefaultStake2;

  @FXML public JFXTextField validatorWalletDeposit1;

  @FXML public JFXTextField validatorDefaultStake1;

  @FXML public JFXTextField nodeSyncBefore3;

  @FXML public JFXTextField nodeKeyProofTtl3;

  @FXML public JFXTextField nodeArchiveTtl3;

  @FXML public JFXTextField nodeBlockTtl3;

  @FXML public JFXTextField nodeStateTtl3;

  @FXML public JFXTextField validatorDefaultStake3;

  @FXML public JFXTextField validatorWalletDeposit3;

  @FXML public JFXTextField configLiteServerPort3;

  @FXML public JFXTextField configNodePublicPort3;

  @FXML public JFXTextField configNodeConsolePort3;

  @FXML public JFXTextField configNodeConsolePort4;

  @FXML public JFXTextField configNodePublicPort4;

  @FXML public JFXTextField configLiteServerPort4;

  @FXML public JFXTextField validatorWalletDeposit4;

  @FXML public JFXTextField validatorDefaultStake4;

  @FXML public JFXTextField nodeStateTtl4;

  @FXML public JFXTextField nodeBlockTtl4;

  @FXML public JFXTextField nodeArchiveTtl4;

  @FXML public JFXTextField nodeKeyProofTtl4;

  @FXML public JFXTextField nodeSyncBefore4;

  @FXML public JFXTextField configNodeConsolePort5;

  @FXML public JFXTextField configNodePublicPort5;

  @FXML public JFXTextField configLiteServerPort5;

  @FXML public JFXTextField validatorWalletDeposit5;

  @FXML public JFXTextField validatorDefaultStake5;

  @FXML public JFXTextField nodeStateTtl5;

  @FXML public JFXTextField nodeBlockTtl5;

  @FXML public JFXTextField nodeArchiveTtl5;

  @FXML public JFXTextField nodeKeyProofTtl5;

  @FXML public JFXTextField nodeSyncBefore5;

  @FXML public JFXTextField configNodeConsolePort6;

  @FXML public JFXTextField configNodePublicPort6;

  @FXML public JFXTextField configLiteServerPort6;

  @FXML public JFXTextField validatorWalletDeposit6;

  @FXML public JFXTextField validatorDefaultStake6;

  @FXML public JFXTextField nodeStateTtl6;

  @FXML public JFXTextField nodeBlockTtl6;

  @FXML public JFXTextField nodeArchiveTtl6;

  @FXML public JFXTextField nodeKeyProofTtl6;

  @FXML public JFXTextField nodeSyncBefore6;

  @FXML public JFXTextField configNodeConsolePort7;

  @FXML public JFXTextField configNodePublicPort7;

  @FXML public JFXTextField configLiteServerPort7;
  ...
  @FXML public JFXTextField nodeBlockTtl7;

  @FXML public JFXTextField nodeArchiveTtl7;

  @FXML public JFXTextField nodeKeyProofTtl7;

  @FXML public JFXTextField nodeSyncBefore7;

  @FXML public Label tonDonationAddress;
  @FXML
  public JFXListView<Node> foundBlockslistviewid,
      foundTxsvboxid,
      foundAccountsvboxid,
      foundAccountsTxsvboxid;
  @FXML public JFXCheckBox tickTockCheckBox;
  @FXML public JFXCheckBox mainConfigTxCheckBox;
  @FXML public JFXCheckBox inOutMsgsCheckBox;
  @FXML
  public CustomComboBox myLogLevel,
      tonLogLevel,
      tonLogLevel2,
      tonLogLevel3,
      tonLogLevel4,
      ...
      tonLogLevel6,
      tonLogLevel7;
  @FXML JFXCheckBox shardStateCheckbox;
  @FXML JFXCheckBox showMsgBodyCheckBox;
  @FXML Label searchTabText;
  @FXML TextField configNodePublicPort1;
  @FXML TextField configNodeConsolePort1;
  @FXML TextField configLiteServerPort1;
  @FXML TextField configDhtServerPort1;
  @FXML ImageView aboutLogo;
  JFXDialog sendDialog;
  JFXDialog yesNoDialog;
  @FXML private Label scrollBtn;
  @FXML private SVGPath scrollPath;
  @FXML
  private CustomTextField validatorLogDir1,
      dhtLogDir1,
      myLocalTonLog,
      validatorLogDir2,
      validatorLogDir3,
  ...
  public void showSendDialog(String srcAddr) {
    FXMLLoader loader =
        new FXMLLoader(
            App.class.getClassLoader().getResource("org/ton/ui/custom/layout/send-coin-pane.fxml"));
    Parent parent = null;
    try {
      parent = loader.load();
    } catch (IOException e) {
        ...
        if (event.getDeltaY() < 0 && bar.getValue() > 0) { // bottom reached
          Platform.runLater(
              () -> {
                ...
                log.debug(
                    "bottom reached, seqno {}, time {}, hwm {} ",
                    lastSeqno,
                    MyLocalTonUtils.toUtcNoSpace(createdAt),
                    MyLocalTon.getInstance().getBlocksScrollBarHighWaterMark().get());

                if (blockslistviewid.getItems().size() > MAX_ROWS_IN_GUI) {
                  showWarningMsg(
                      "Maximum amount ("
                          + MyLocalTon.getInstance().getBlocksScrollBarHighWaterMark().get()
                          + ") of visible blocks in GUI reached.",
                      5);
                  return;
                }
  ...
  public void initialize(URL url, ResourceBundle resourceBundle) {
    ...
    superWindow.setOnMousePressed(
        pressEvent -> {
          superWindow.setOnMouseDragged(
              dragEvent -> {
    ...
    EventHandler<KeyEvent> onlyDigits =
        keyEvent -> {
          if (!((TextField) keyEvent.getSource()).getText().matches("[\\d\\.\\-]+")) {
            ((TextField) keyEvent.getSource())
                .setText(
                    ((TextField) keyEvent.getSource()).getText().replaceAll("[^\\d\\.\\-]", ""));
          }
        };
    ...
    maxMainValidators.setFieldText(
        settings.getBlockchainSettings().getMaxMainValidators().toString());

    electedFor.setFieldText(settings.getBlockchainSettings().getElectedFor().toString());
    electionStartBefore.setFieldText(
        settings.getBlockchainSettings().getElectionStartBefore().toString());
    electionEndBefore.setFieldText(
        settings.getBlockchainSettings().getElectionEndBefore().toString());
    stakesFrozenFor.setFieldText(
        settings.getBlockchainSettings().getElectionStakesFrozenFor().toString());
    ...
    validatorWalletDeposit1.setText(
        settings.getGenesisNode().getInitialValidatorWalletAmount().toString());
    ...
    validatorWalletDeposit2.setText(
        settings.getNode2().getInitialValidatorWalletAmount().toString());
    ...
    validatorWalletDeposit3.setText(
        settings.getNode3().getInitialValidatorWalletAmount().toString());
    ...
    validatorWalletDeposit4.setText(
        settings.getNode4().getInitialValidatorWalletAmount().toString());
    ...
    validatorWalletDeposit5.setText(
        settings.getNode5().getInitialValidatorWalletAmount().toString());
    ...
    validatorWalletDeposit6.setText(
        settings.getNode6().getInitialValidatorWalletAmount().toString());
    ...
    validatorWalletDeposit7.setText(
  ...
  public void showAccTxs(String hexAddr) {
    ...
    CompletableFuture.supplyAsync(() -> App.dbPool.searchTxs(hexAddr), ForkJoinPool.commonPool())
        .thenAccept(
            foundAccountTxsEntities -> {
              Platform.runLater(
                  () -> {
                    MyLocalTon.getInstance()
                        .showFoundTxsInGui(
                            foundAccountsTxsvboxid, foundAccountTxsEntities, hexAddr, hexAddr);
                  });
            })
        .exceptionally(
            ex -> {
              ...
              Platform.runLater(
                  () -> App.mainController.showErrorMsg("Error searching account transactions", 3));
              return null;
            });
  }
  ...
  public void saveSettings() {
    ...
    settings
        ...
        .setMaxMainValidators(Long.valueOf(maxMainValidators.getFieldText()));
    ...
    settings
        .getBlockchainSettings()
        .setElectionStartBefore(Long.valueOf(electionStartBefore.getFieldText()));
    settings
        .getBlockchainSettings()
        .setElectionEndBefore(Long.valueOf(electionEndBefore.getFieldText()));
    settings
        .getBlockchainSettings()
        .setElectionStakesFrozenFor(Long.valueOf(stakesFrozenFor.getFieldText()));
    ...
    settings
        .getGenesisNode()
        .setInitialValidatorWalletAmount(new BigInteger(validatorWalletDeposit1.getText()));
    settings
        .getGenesisNode()
        .setDefaultValidatorStake(new BigInteger(validatorDefaultStake1.getText()));
    ...
    settings
        .getNode2()
        .setInitialValidatorWalletAmount(new BigInteger(validatorWalletDeposit2.getText()));
    ...
    settings
        .getNode3()
        .setInitialValidatorWalletAmount(new BigInteger(validatorWalletDeposit3.getText()));
    ...
    settings
        .getNode4()
        .setInitialValidatorWalletAmount(new BigInteger(validatorWalletDeposit4.getText()));
    ...
    settings
        .getNode5()
        .setInitialValidatorWalletAmount(new BigInteger(validatorWalletDeposit5.getText()));
    ...
    settings
        .getNode6()
        .setInitialValidatorWalletAmount(new BigInteger(validatorWalletDeposit6.getText()));
  ...
  public void liteServerClicked() throws IOException {
    String lastCommand =
        LiteClient.getInstance(LiteClientEnum.GLOBAL)
            .getLastCommand(MyLocalTon.getInstance().getSettings().getGenesisNode());
    log.info("show console with last command, {}", lastCommand);

    if (SystemUtils.IS_OS_WINDOWS) {
      log.info("cmd /c start cmd.exe /k \"echo " + lastCommand + " && " + lastCommand + "\"");
      Runtime.getRuntime()
          .exec("cmd /c start cmd.exe /k \"echo " + lastCommand + " && " + lastCommand + "\"");
  ...
  public void resetAction() {
    FXMLLoader loader =
        new FXMLLoader(
            App.class
                .getClassLoader()
                .getResource("org/ton/ui/custom/layout/reset-blockchain-pane.fxml"));
          ...
          try {
            FXMLLoader loader =
                new FXMLLoader(
                    App.class
                        .getClassLoader()
                        .getResource("org/ton/ui/custom/layout/confirm-pane.fxml"));
        ...
        () -> {
          try {
            ...
            if (SystemUtils.IS_OS_WINDOWS) {
              ...
              log.info(
                  "total active nodes {} vs minimum required {}",
                  settings.getActiveNodes().size(),
                  cutoff);
              if ((settings.getActiveNodes().size() - 1 < cutoff)
                  || (settings.getActiveNodes().size() == 3 && cutoff == 2)) {
                stopsWokring =
            ...
            controller.setBody(
                "Are you sure you want to delete the selected validator? All data and funds will be lost and obviously validator will be removed from elections. Don't forget to collect all validation rewards."
                    + stopsWokring);
  ...
  public void showMessage(String msg) {
    try {
      ...
      FXMLLoader loader =
          new FXMLLoader(
              App.class.getClassLoader().getResource("org/ton/ui/custom/layout/confirm-pane.fxml"));
      Parent parent = loader.load();
      ConfirmPaneController controller = loader.getController();
      controller.setAction(ConfirmPaneController.Action.CONFIRM);
  ...
  public void createNewAccountBtn() throws IOException {
    ...
    FXMLLoader loader =
        new FXMLLoader(
            App.class
                .getClassLoader()
                .getResource("org/ton/ui/custom/layout/accounts-create-pane.fxml"));
    Parent parent = loader.load();
  ...
  public void updateValidationTabInfo() {
    try {
      ...
      String previous =
          "Previous validators (Public key, ADNL address, weight): "
              ...
              + config32.getValidators().getValidators().stream()
                  .map(i -> i.getPublicKey() + "  " + i.getAdnlAddress() + "  " + i.getWeight())
      ...
      long validationStartInAgoSeconds =
          Math.abs(MyLocalTonUtils.getCurrentTimeSeconds() - v.getStartValidationCycle());
      String startsValidationDuration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(validationStartInAgoSeconds).toMillis(),
              "HH:mm:ss",
              true);
      if ((MyLocalTonUtils.getCurrentTimeSeconds() - v.getStartValidationCycle()) > 0) {
        startCycle.setText(
            MyLocalTonUtils.toLocal(v.getStartValidationCycle())
                + "  Started ago ("
                + startsValidationDuration
                + ")");
      } else {
        startCycle.setText(
            MyLocalTonUtils.toLocal(v.getStartValidationCycle())
      ...
      String validation1Duration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(validationDurationInSeconds).toMillis(),
              "HH:mm:ss",
              true);
      endCycle.setText(
          MyLocalTonUtils.toLocal(v.getEndValidationCycle())
              + "  Duration ("
              + validation1Duration
              + ")");

      long electionsStartsInAgoSeconds =
          Math.abs(MyLocalTonUtils.getCurrentTimeSeconds() - v.getStartElections());
      String startsElectionDuration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(electionsStartsInAgoSeconds).toMillis(),
              "HH:mm:ss",
              true);
      if ((MyLocalTonUtils.getCurrentTimeSeconds() - v.getStartElections()) > 0) {
        startElections.setText(
            MyLocalTonUtils.toLocal(v.getStartElections())
                + "  Started ago ("
                + startsElectionDuration
                + ") Election Id "
                + v.getStartValidationCycle());
        startElections.setTooltip(
            new Tooltip(
                "Election Id (" + MyLocalTonUtils.toLocal(v.getStartValidationCycle()) + ")"));
      } else {
        startElections.setText(
            MyLocalTonUtils.toLocal(v.getStartElections())
                + "  Starts in ("
      ...
      String elections1Duration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(electionDurationInSeconds).toMillis(), "HH:mm:ss", true);

      endElections.setText(
          MyLocalTonUtils.toLocal(v.getEndElections()) + "  Duration (" + elections1Duration + ")");

      long nextElectionsStartsInAgoSeconds =
          Math.abs(MyLocalTonUtils.getCurrentTimeSeconds() - v.getNextElections());
      String nextElectionDuration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(nextElectionsStartsInAgoSeconds).toMillis(),
              "HH:mm:ss",
              true);
      if ((MyLocalTonUtils.getCurrentTimeSeconds() - v.getNextElections()) > 0) {
        nextElections.setText(
            MyLocalTonUtils.toLocal(v.getNextElections())
                + "  Started ago ("
                + nextElectionDuration
                + ")");
      } else {
        nextElections.setText(
            MyLocalTonUtils.toLocal(v.getNextElections())
      ...
      validationPeriod.setText(
          v.getValidationDuration().toString()
              + " ("
              + DurationFormatUtils.formatDuration(
                  java.time.Duration.ofSeconds(v.getValidationDuration()).toMillis(),
                  "HH:mm:ss",
                  true)
              + ")");
      electionPeriod.setText(
          v.getElectionDuration().toString()
              + " ("
              + DurationFormatUtils.formatDuration(
                  java.time.Duration.ofSeconds(v.getElectionDuration()).toMillis(),
                  "HH:mm:ss",
                  true)
              + ")");

      holdPeriod.setText(
          v.getHoldPeriod().toString()
              + " ("
              + DurationFormatUtils.formatDuration(
                  java.time.Duration.ofSeconds(v.getHoldPeriod()).toMillis(), "HH:mm:ss", true)
              + ")");
  ...
  private void updateValidator1TabPage(ValidationParam v) {
    ...
    if (nonNull(node1.getWalletAddress())) {
      if (isNull(
          node1.getPrevValidationAndlKey())) { // very first elections, no previous validators yet
    ...
    if (nonNull(node2.getWalletAddress())) {
      if (nonNull(node2.getPrevValidationAndlKey())) {
        for (Validator validator :
            v.getCurrentValidators()) { // in a list of current validators we must find an entry
  ...
  private void calculateTimeLineScale() {
    ...
    log.debug(
        "startXHoldStakeLine3 {}, endHoldStake2 {}, endHoldStake3 {} holdStakeWidth {}",
        startXHoldStakeLine3,
        endHoldStake2,
        endHoldStake3,
        holdStakeWidth);
  ...
  public void drawTimeLine() {
    ...
    if (nonNull(settings.getTimeLineScale())) {
      ...
      log.debug(
          "electionsDelta {}, electionsDeltaWidth {}, timeScale {}, xcoord {}, x {}, v.getStartElections() {}, sizeElections {}",
          electionsDelta,
          electionsDeltaWidth,
          settings.getTimeLineScale(),
          xcoord,
          x,
          MyLocalTonUtils.toLocal(v.getStartElections()),
          settings.elections.size());
  ...
  private void positionBars(ValidationParam v) {
    // assume duration of validation cycle is 1 unit of 200 pixels, then other ranges scaled down/up
    // accordingly
    double scaleFactor = (double) 200 / v.getValidationDuration();
    ...
    long startXElectionsLine2 =
        (long)
                ((startXValidationLine1 + validationWidth)
                    - (scaleFactor * v.getStartElectionsBefore()))
            - 3;
    ...
    log.debug(
        "electionsWidth {}, pauseWidth {}, validationWidth {}, hostStakeWidth {}",
        electionsWidth,
        pauseWidth,
        validationWidth,
        holdStakeWidth);
  ...
  private void addLabelsToBars2(ValidationParam v1) {
    ...
    if (settings.elections.size() == 1) {
      elections1Duration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(electionDurationInSeconds1).toMillis(),
              "HH:mm:ss",
              true);
      elections1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v1.getStartElections()),
              MyLocalTonUtils.toLocal(v1.getEndElections()),
              elections1Duration);
      ...
      pause1Duration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(pauseDurationInSeconds).toMillis(), "HH:mm:ss", true);
      String pause1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v1.getEndElections()),
              MyLocalTonUtils.toLocal(v1.getStartValidationCycle()),
              pause1Duration);
      ...
      validation1Duration =
          DurationFormatUtils.formatDuration(
              ...
              "HH:mm:ss",
              true);
      String validation1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v1.getStartValidationCycle()),
              MyLocalTonUtils.toLocal(v1.getEndValidationCycle()),
              validation1Duration);
      ...
      stakeHold1Duration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(stakeHoldDurationInSeconds).toMillis(),
              "HH:mm:ss",
              true);
      String holdStake1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v1.getEndValidationCycle()),
              MyLocalTonUtils.toLocal(
                  java.time.Duration.ofSeconds(v1.getEndValidationCycle())
                      .plusSeconds(v1.getHoldPeriod())
                      .toSeconds()),
              stakeHold1Duration);
      ...
      // 2
      long endElections2 =
          java.time.Duration.ofSeconds(v1.getNextElections())
              .plusSeconds(electionDurationInSeconds1)
              .toSeconds();
      String elections2ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v1.getNextElections()),
              MyLocalTonUtils.toLocal(endElections2),
              elections1Duration);
      electionsRange2.setTooltip(new Tooltip(elections2ToolTip));

      long endPause2 =
          java.time.Duration.ofSeconds(endElections2)
              .plusSeconds(pauseDurationInSeconds)
              .toSeconds();
      String pause2ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(endElections2),
              MyLocalTonUtils.toLocal(endPause2),
              pause1Duration);
      pauseRange2.setTooltip(new Tooltip(pause2ToolTip));

      long endValidation2 =
          java.time.Duration.ofSeconds(endPause2)
              .plusSeconds(validationDurationInSeconds)
              .toSeconds();
      String validation2ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(endPause2),
              MyLocalTonUtils.toLocal(endValidation2),
              validation1Duration);
      validationRange2.setTooltip(new Tooltip(validation2ToolTip));

      long endHoldStake2 =
          java.time.Duration.ofSeconds(endValidation2).plusSeconds(v1.getHoldPeriod()).toSeconds();
      String holdStake2ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(endValidation2),
              MyLocalTonUtils.toLocal(endHoldStake2),
              stakeHold1Duration);
      stakeHoldRange2.setTooltip(new Tooltip(holdStake2ToolTip));
      settings.setStakeHoldRange2End(endHoldStake2);

      // 3
      long startElections3 =
          java.time.Duration.ofSeconds(v1.getNextElections())
              .plusSeconds(electionsDelta1)
              .toSeconds();
      long endElections3 =
          java.time.Duration.ofSeconds(v1.getNextElections())
              .plusSeconds(electionDurationInSeconds1 + electionsDelta1)
              .toSeconds();
      String elections3ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(startElections3),
              MyLocalTonUtils.toLocal(endElections3),
              elections1Duration);
      electionsRange3.setTooltip(new Tooltip(elections3ToolTip));

      long endPause3 =
          java.time.Duration.ofSeconds(endElections3)
              .plusSeconds(pauseDurationInSeconds)
              .toSeconds();
      String pause3ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(endElections3),
              MyLocalTonUtils.toLocal(endPause3),
              pause1Duration);
      pauseRange3.setTooltip(new Tooltip(pause3ToolTip));

      long endValidation3 =
          java.time.Duration.ofSeconds(endPause3)
              .plusSeconds(validationDurationInSeconds)
              .toSeconds();
      String validation3ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(endPause3),
              MyLocalTonUtils.toLocal(endValidation3),
              validation1Duration);
      validationRange3.setTooltip(new Tooltip(validation3ToolTip));

      long endHoldStake3 =
          java.time.Duration.ofSeconds(endValidation3).plusSeconds(v1.getHoldPeriod()).toSeconds();
      String holdStake3ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(endValidation3),
              MyLocalTonUtils.toLocal(endHoldStake3),
              stakeHold1Duration);
      ...
      elections1Duration =
          DurationFormatUtils.formatDuration(
              java.time.Duration.ofSeconds(electionDurationInSeconds2).toMillis(),
              "HH:mm:ss",
              true);
      elections1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v2.getStartElections()),
              MyLocalTonUtils.toLocal(v2.getEndElections()),
              elections1Duration);
      electionsRange1.setTooltip(new Tooltip(elections1ToolTip));
      ...
      String pause1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v2.getEndElections()),
              MyLocalTonUtils.toLocal(v2.getStartValidationCycle()),
              pause1Duration);
      pauseRange1.setTooltip(new Tooltip(pause1ToolTip));
      ...
      String validation1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v2.getStartValidationCycle()),
              MyLocalTonUtils.toLocal(v2.getEndValidationCycle()),
              validation1Duration);
      validationRange1.setTooltip(new Tooltip(validation1ToolTip));
      ...
      String holdStake1ToolTip =
          String.format(
              ...
              MyLocalTonUtils.toLocal(v2.getEndValidationCycle()),
              MyLocalTonUtils.toLocal(
                  java.time.Duration.ofSeconds(v2.getEndValidationCycle())
                      .plusSeconds(v2.getHoldPeriod())
                      .toSeconds()),
              stakeHold1Duration);
      stakeHoldRange1.setTooltip(new Tooltip(holdStake1ToolTip));
      ...
      // 2
      long endElections2 =
          java.time.Duration.ofSeconds(v1.getStartElections())
              .plusSeconds(electionDurationInSeconds1)
              .toSeconds();
      String elections2ToolTip =
          String.format(
      ...
      long endElections3 =
          java.time.Duration.ofSeconds(v1.getNextElections())
              .plusSeconds(electionDurationInSeconds2)
              .toSeconds();
      String elections3ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
  ...
  public void showLoadingPane(String line1, String line2) {
    FXMLLoader loader =
        new FXMLLoader(
            App.class.getClassLoader().getResource("org/ton/ui/custom/layout/loading-pane.fxml"));
    Parent parent = null;
    try {
      parent = loader.load();
    } catch (IOException e) {
  ...
  public void closeWindow(ActionEvent actionEvent) {
    App.primaryStage.fireEvent(new WindowEvent(App.primaryStage, WindowEvent.WINDOW_CLOSE_REQUEST));
  }
}
