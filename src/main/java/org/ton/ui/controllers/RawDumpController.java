...
import org.ton.utils.NotificationUtils;
            ...
            try {
                switch (action) {
                    case "block":
                        ...
                        stdout = LiteClient.getInstance(LiteClientEnum.GLOBAL)
                            .executeDumpblock(MyLocalTon.getInstance().getSettings().getGenesisNode(), data);
                    ...
                    case "tx":
                        ...
                        stdout = LiteClient.getInstance(LiteClientEnum.GLOBAL)
                            .executeDumptrans(MyLocalTon.getInstance().getSettings().getGenesisNode(), data);
                    ...
                    case "account":
                        ...
                        stdout = LiteClient.getInstance(LiteClientEnum.GLOBAL)
                            .executeGetAccount(MyLocalTon.getInstance().getSettings().getGenesisNode(), data);
