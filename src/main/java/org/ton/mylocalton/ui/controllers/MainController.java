...
import org.ton.mylocalton.settings.Node3;
import org.ton.mylocalton.settings.Node4;
import org.ton.mylocalton.settings.Node5;
import org.ton.mylocalton.settings.Node6;
import org.ton.mylocalton.settings.Node7;
import org.ton.mylocalton.ui.custom.control.CustomComboBox;
import org.ton.mylocalton.ui.custom.control.CustomInfoLabel;
...
public class MainController implements Initializable {
  ...
  public void resetAction() {
    FXMLLoader loader =
        new FXMLLoader(
            App.class
                .getClassLoader()
                .getResource("org/ton/mylocalton/ui/custom/layout/reset-blockchain-pane.fxml"));
  ...
  public void showDialogConfirmDeleteNode(org.ton.mylocalton.settings.Node node) {
    Platform.runLater(
        () -> {
          try {
  ...
  public void createNewAccountBtn() throws IOException {
    ...
    FXMLLoader loader =
        new FXMLLoader(
            App.class
                .getClassLoader()
                .getResource("org/ton/mylocalton/ui/custom/layout/accounts-create-pane.fxml"));
    Parent parent = loader.load();
          ...
          () -> {
            ...
            String startsValidationDuration =
                DurationFormatUtils.formatDuration(
                    Duration.ofSeconds(validationStartInAgoSeconds).toMillis(), "HH:mm:ss", true);
            ...
            long validationDurationInSeconds =
                v.getEndValidationCycle() - v.getStartValidationCycle();
            String validation1Duration =
                DurationFormatUtils.formatDuration(
                    Duration.ofSeconds(validationDurationInSeconds).toMillis(), "HH:mm:ss", true);
            endCycle.setText(
            ...
            String startsElectionDuration =
                DurationFormatUtils.formatDuration(
                    Duration.ofSeconds(electionsStartsInAgoSeconds).toMillis(), "HH:mm:ss", true);
            ...
            String elections1Duration =
                DurationFormatUtils.formatDuration(
                    Duration.ofSeconds(electionDurationInSeconds).toMillis(), "HH:mm:ss", true);
            ...
            String nextElectionDuration =
                DurationFormatUtils.formatDuration(
                    Duration.ofSeconds(nextElectionsStartsInAgoSeconds).toMillis(),
                    "HH:mm:ss",
                    true);
            ...
            validationPeriod.setText(
                v.getValidationDuration().toString()
                    + " ("
                    + DurationFormatUtils.formatDuration(
                        Duration.ofSeconds(v.getValidationDuration()).toMillis(), "HH:mm:ss", true)
                    + ")");
            electionPeriod.setText(
                v.getElectionDuration().toString()
                    + " ("
                    + DurationFormatUtils.formatDuration(
                        Duration.ofSeconds(v.getElectionDuration()).toMillis(), "HH:mm:ss", true)
                    + ")");
  ...
  private void addLabelsToBars2(ValidationParam v1) {
    ...
    if (settings.elections.size() == 1) {
      elections1Duration =
          DurationFormatUtils.formatDuration(
              Duration.ofSeconds(electionDurationInSeconds1).toMillis(), "HH:mm:ss", true);
      elections1ToolTip =
          String.format(
      ...
      pause1Duration =
          DurationFormatUtils.formatDuration(
              Duration.ofSeconds(pauseDurationInSeconds).toMillis(), "HH:mm:ss", true);
      ...
      stakeHold1Duration =
          DurationFormatUtils.formatDuration(
              Duration.ofSeconds(stakeHoldDurationInSeconds).toMillis(), "HH:mm:ss", true);
      String holdStake1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
              MyLocalTonUtils.toLocal(v1.getEndValidationCycle()),
              MyLocalTonUtils.toLocal(
                  Duration.ofSeconds(v1.getEndValidationCycle())
      ...
      // 2
      long endElections2 =
          Duration.ofSeconds(v1.getNextElections())
      ...
      long endPause2 =
          Duration.ofSeconds(endElections2).plusSeconds(pauseDurationInSeconds).toSeconds();
      ...
      long endValidation2 =
          Duration.ofSeconds(endPause2).plusSeconds(validationDurationInSeconds).toSeconds();
      ...
      long endHoldStake2 =
          Duration.ofSeconds(endValidation2).plusSeconds(v1.getHoldPeriod()).toSeconds();
      ...
      long startElections3 =
          Duration.ofSeconds(v1.getNextElections()).plusSeconds(electionsDelta1).toSeconds();
      long endElections3 =
          Duration.ofSeconds(v1.getNextElections())
      ...
      long endPause3 =
          Duration.ofSeconds(endElections3).plusSeconds(pauseDurationInSeconds).toSeconds();
      ...
      long endValidation3 =
          Duration.ofSeconds(endPause3).plusSeconds(validationDurationInSeconds).toSeconds();
      ...
      long endHoldStake3 =
          Duration.ofSeconds(endValidation3).plusSeconds(v1.getHoldPeriod()).toSeconds();
      ...
      elections1Duration =
          DurationFormatUtils.formatDuration(
              Duration.ofSeconds(electionDurationInSeconds2).toMillis(), "HH:mm:ss", true);
      elections1ToolTip =
          String.format(
              "Start: %s%nEnd: %s%nDuration: %s",
      ...
      String holdStake1ToolTip =
          String.format(
              ...
              MyLocalTonUtils.toLocal(v2.getEndValidationCycle()),
              MyLocalTonUtils.toLocal(
                  Duration.ofSeconds(v2.getEndValidationCycle())
      ...
      // 2
      long endElections2 =
          Duration.ofSeconds(v1.getStartElections())
              .plusSeconds(electionDurationInSeconds1)
              .toSeconds();
      String elections2ToolTip =
          String.format(
      ...
      // 3
      long startElections3 = Duration.ofSeconds(v1.getNextElections()).toSeconds();
      long endElections3 =
          Duration.ofSeconds(v1.getNextElections())
  ...
  public void showLoadingPane(String line1, String line2) {
    FXMLLoader loader =
        new FXMLLoader(
            App.class
                .getClassLoader()
                .getResource("org/ton/mylocalton/ui/custom/layout/loading-pane.fxml"));
    Parent parent = null;
    try {
      parent = loader.load();
    } catch (IOException e) {
